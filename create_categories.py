...
Creates some categories for initializing the catalog application.
...
categories = [
    ...
    {"name": "Automobiles",
        "description": "New and used automobiles for sale."},
    ...
    {"name": "Household Items",
        "description": "New and used household items for sale."},
    {"name": "Jewelry", "description": "New and used jewelry for sale."},
    {"name": "Photography",
     "description": "New and used cameras and equipment for sale."},
    {"name": "Motorcycles",
        "description": "New and used motorcycles for sale."},
    {"name": "Musical Instruments",
        "description": "New and used musical instruments for sale."},
    {"name": "Sporting Goods",
        "description": "New and used sporting goods for sale."},
]
